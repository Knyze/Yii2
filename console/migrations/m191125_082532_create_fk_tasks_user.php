...
class m191125_082532_create_fk_tasks_user extends Migration
{
    ...
    {
        $this->addForeignKey('tasks_fk1', 'tasks_tbl', 'executor_id', 'users_tbl', 'user_id', 'NO ACTION');
        $this->addForeignKey('tasks_fk2', 'tasks_tbl', 'creator_id', 'users_tbl', 'user_id', 'NO ACTION');
        $this->addForeignKey('tasks_fk3', 'tasks_tbl', 'updater_id', 'users_tbl', 'user_id', 'NO ACTION');
    }
